// Adapted from StangeIOC Signals
// Removed event/delegate architecutre and replaced with basic action list in order to provide AOT compatability in a third party dll
...
namespace General.Signals
{
	...
	public class WeakActionHandler : IWeakActionHandler
	{
		...
		public bool Invoke()
		{
			var target = this.m_targetReference.Target;
